...
3. Please provide a link to the repository you are using for this class.
    ...
    https://github.com/ssong0320/SysProg-Class

4. Briefly describe what you want to get out of this class.

    I hope to gain a deeper understanding of low-level programming concepts and develop the skills to write efficient, robust, and scalable systems software.

5. Briefly describe any concerns you might be having with being successful in this class (if any).

    I am currently pretty rusty with the C programming language so the first couple weeks might be challenging until I get used to working with it again.